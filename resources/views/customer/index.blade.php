...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-2">
        <a href="{{route('admin.customer.goadd')}}" class="btn btn-success" style="color:#fff;">Thêm mới</a>
        </div>
    </div>    
...
<table id="customer" align="center" width="100%" class="table table-hover table-striped table-bordered border text-center display">
  ...
  @foreach($customers as $key=>$customer)
    <tr>
      ...
      <td>
        <a href="{{route('admin.customer.goedit',$customer->id)}}" style="color:#fff;"  class="btn btn-info">Cập nhật</a>
        <a href="{{route('admin.customer.delete',$customer->id)}}" class="btn btn-danger" style="color:#fff;">Xóa</a>
      </td>
    </tr>
    @endforeach
  </tbody>
